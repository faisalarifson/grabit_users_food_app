...
class _PlacedOrderScreenState extends State<PlacedOrderScreen> {
  ...
  addOrderDetails({required DateTime time}) {
    writeOrderDetailsForUser({
      ...
      "orderTime":time.millisecondsSinceEpoch.toString(),
      "isSuccess": true,
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  addOrderDetails(time: DateTime.now());
                },
              ),
            ),
              ...
              child: ElevatedButton(
                ...
                onPressed: ()async {
                 ...
                 DateTime? dateTime=await
                  ...
                  addOrderDetails(time: dateTime??DateTime.now());
                },
              ),
            ),
          ],
